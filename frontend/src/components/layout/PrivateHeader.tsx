      ...
      <div className="flex items-center space-x-2 lg:space-x-3">
        ...
        >
          ...
          <div className="flex flex-col">
            {/* HEADER */}
            <div className="px-3 py-2 text-[10px] uppercase font-bold text-[color:var(--muted-foreground)] bg-[color:var(--secondary)]/50 border-b border-[color:var(--border)]">
              Switch Organization
            </div>
              ...
              {organizations.map((org) => (
                ...
                >
                  <div className="flex items-center px-3 py-2">
                    <div className="w-6 h-6 bg-primary/10 rounded flex items-center justify-center text-primary text-[10px] font-bold mr-3">
                      {org?.organization?.name?.charAt(0).toUpperCase()}
                    </div>
                    <span className="text-sm font-medium truncate text-[color:var(--foreground)]">
        ...
        <Dropdown
          ...
          trigger={
            <Button
              variant="ghost"
              size="sm"
              className="flex items-center space-x-3 px-2 lg:px-3 h-10 hover:bg-[color:var(--secondary)] transition-colors"
            >
              {/* Avatar */}
              ...
              <ChevronDown className="w-3.5 h-3.5 text-[color:var(--muted-foreground)]" />
            </Button>
          }
        >
          <div className="flex flex-col w-56">
            {/* Account Info Section */}
            <div className="px-4 py-3 bg-[color:var(--secondary)]/50 border-b border-[color:var(--border)]">
              <p className="text-[10px] font-bold text-[color:var(--muted-foreground)] uppercase tracking-tight">
                Account
              </p>
            ...
            <div className="py-1">
              <DropdownItem onClick={() => router.push("/profile")}>
                <div className="flex items-center px-4 py-2 text-sm text-[color:var(--foreground)] font-medium">
                  <User className="w-4 h-4 mr-3 text-[color:var(--muted-foreground)]" />
                  Profile Settings
                </div>
              </DropdownItem>
              ...
              >
                <div className="flex items-center px-4 py-2 text-sm text-[color:var(--foreground)] font-medium">
                  <Building className="w-4 h-4 mr-3 text-[color:var(--muted-foreground)]" />
            ...
            {/* Footer / Logout */}
            <div className="border-t border-[color:var(--border)] mt-1 py-1 bg-[color:var(--secondary)]/30">
